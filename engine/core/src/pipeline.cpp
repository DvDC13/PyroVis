...
namespace Pyro
{
    Pipeline:: Pipeline(Device& device, const std::string& vertexShaderPath, const std::string& fragmentShaderPath, const PipelineConfigInfo& configInfo)
        : device_(device)
    {
    ...
    void Pipeline::createGraphicsPipeline(const std::string& vertexShaderPath, const std::string& fragmentShaderPath, const PipelineConfigInfo& configInfo)
    {
        ...
        createShaderModule(vertexCode, &vertShaderModule_);
        createShaderModule(fragmentCode, &fragShaderModule_);
